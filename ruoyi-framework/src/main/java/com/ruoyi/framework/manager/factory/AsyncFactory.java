...
//                logininfor.setUserName(username);
     ...
     * 管理员操作日志记录
     * 
     * @param adminLog 管理员操作日志信息
     * @return 任务task
     */
    public static TimerTask recordAdminLog(final BbsAdminLog adminLog)
    {
        return new TimerTask()
        {
            @Override
            public void run()
            {
                SpringUtils.getBean(IBbsAdminLogService.class).insertBbsAdminLog(adminLog);
            }
        };
    }
}
